...
// class ChatScreenVet extends StatefulWidget {
//   final String petId;
//   final String petName;

//   const ChatScreenVet({super.key, required this.petId, required this.petName});

//   @override
//   _ChatScreenVetState createState() => _ChatScreenVetState();
// }

// class _ChatScreenVetState extends State<ChatScreenVet> {
...
//     await _firestore.collection('chats').doc(currentUser!.uid).collection(widget.petId).add({
//       'senderId': currentUser!.uid,
//       'receiverId': widget.petId,
...
//     return Scaffold(
//       appBar: AppBar(title: Text("Chat with ${widget.petName}")),
//       body: Column(
//         children: [
//           Expanded(
